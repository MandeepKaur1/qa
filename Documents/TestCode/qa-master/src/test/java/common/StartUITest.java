...
public class StartUITest {
    ...
    public void getEnvironment() {
        ...
        driver.get(FrameworkConstants.ENVIRONMENT_STAGING);
    }
   ...
   // @BeforeClass
    ...
    //@BeforeClass
    public void remote_browser_firefox() throws MalformedURLException {
        String platform = "MAC";
        browserName = "Firefox";
        String OSversion = "Lion";
        logger.info("Selected Browser to Run Test is Firefox");
        capabilities.setCapability("name", sessionName);
        capabilities.setCapability("browserName", browserName);
